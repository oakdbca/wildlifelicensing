...
class CustomerEditProfileViewTest(helpers.BasePermissionViewTestCase):
    ...
    def setUp(self):
        self.view_url = reverse(
            "wl_customer_management:edit_customer_profile", args=[self.customer.pk]
        )
...
class CustomerApplicationViewTest(helpers.BasePermissionViewTestCase):
    ...
    def setUp(self):
        self.view_url = reverse(
            "wl_customer_management:data_applications", args=[self.customer.pk]
        )
...
class CustomerLicenceViewTest(helpers.BasePermissionViewTestCase):
    ...
    def setUp(self):
        self.view_url = reverse(
            "wl_customer_management:data_licences", args=[self.customer.pk]
        )
...
class CustomerReturnViewTest(helpers.BasePermissionViewTestCase):
    ...
    def setUp(self):
        self.view_url = reverse(
            "wl_customer_management:data_returns", args=[self.customer.pk]
        )
