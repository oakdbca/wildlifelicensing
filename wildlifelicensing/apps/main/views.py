        ...
        if "discontinue" in request.POST:
            ...
            if emailuser_form.is_valid():
                ...
                if new_user and not unique:
                    ...
                    If you already have a Parks and Wildlife customer account under another email address,
                    please discontinue this registration and sign in with your existing account and add any
                    additional email addresses as new profiles."""
