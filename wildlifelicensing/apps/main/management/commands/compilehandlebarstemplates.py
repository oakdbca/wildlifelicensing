    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            default=os.path.join(
                ...
                "wl",
                "js",
                "precompiled_handlebars_templates.js",
            ),
            help="output file",
        )
        ...
        parser.add_argument(
            "-p",
            default="handlebars_templates",
            help="Handlebars template root directory",
        )
        ...
        for app in settings.INSTALLED_APPS:
            ...
            if os.path.isdir(app_handlebars_templates_path):
                for handlebars_template in os.listdir(app_handlebars_templates_path):
                    handlebars_templates.append(
                        os.path.join(app_handlebars_templates_path, handlebars_template)
                    )
