...
from wildlifelicensing.apps.emails.emails import MAX_SUBJECT_LENGTH, TemplateEmailBase
...
class EmailTest(TestCase):
    ...
    def test_subject_max_length(self):
        ...
        subject = (
            "A verrrrrrrryyyyyyyyyyyyyyyyyy "
            "loooooooooooooooooooooooooooooooooooooooong "
            "subbbbbbbbbjjjjjjjjjjeeeeeect"
        )
        ...
        expected_subject = f"{subject[:MAX_SUBJECT_LENGTH - 2]}.."
