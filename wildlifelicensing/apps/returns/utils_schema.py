...
# TODO: fix the deprecation of SchemaModel.
# Use jsontableschema.model.Schema, but there is a problem (see below)
...
class Schema:
    ...
    def post_validate_lat_long_easting_northing(self, field_validation):
        ...
        :param field_validation: We expect that the data has been validated
        at the field level and the argument should be
