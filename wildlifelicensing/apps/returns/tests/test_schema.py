...
class TestSchemaConstraints(TestCase):
    def test_none_or_empty(self):
        ...
        """
        self.assertEqual({}, SchemaConstraints(None).data)
        self.assertEqual({}, SchemaConstraints({}).data)
...
class TestSchemaFieldCast(TestCase):
    ...
    def test_date_custom_format(self):
        ...
        descriptor = {"name": "Date with fmt", "type": "date", "format": format_}
...
class TestSchemaFieldValidation(TestCase):
    ...
    def test_enums(self):
        ...
        descriptor = {
            ...
            "type": "string",
            "format": "default",
            "constraints": {"required": False, "enum": ["val1", "val2", "val3"]},
        }
        f = SchemaField(descriptor)
...
class TestSpeciesField(TestCase):
    ...
    def test_species_by_wl_tag(self):
        ...
        self.assertEqual(field["name"], sch.species_fields[0].name)
        ...
        self.schema_descriptor = {
            "fields": [
                ...
                },
                {
                    "type": "number",
                    "name": "LATITUDE",
                    "constraints": {"minimum": -60.0, "maximum": 0, "required": True},
                },
                {
                    "type": "number",
                    "name": "LONGITUDE",
                ...
                },
                {
                    "type": "number",
                    "name": "ZONE",
                    "constraints": {"required": True, "enum": [49, 50, 51, 52]},
                },
                {
                    "type": "number",
                    "name": "EASTING",
