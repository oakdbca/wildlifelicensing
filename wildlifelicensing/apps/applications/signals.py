...
# TODO: Make sure an equivalient to this signal is done at some point
# Just commenting out for now to get application working
    ...
    if "ret" in kwargs:
        ...
        try:
            ...
            if application.returns_check_status == "awaiting_returns":
                if (
                    not Return.objects.filter(licence=ret.licence)
