...
class ProcessView(OfficerOrAssessorRequiredMixin, TemplateView):
    ...
    def _build_data(self, request, application):
        ...
        data = {
            ...
            # 'application': serialize(application,posthook=format_application,
            # 'application': serialize(application,posthook=format_application,
            # exclude=['previous_application', 'licence'],
            # 'application': serialize(application,posthook=format_application,
            # exclude=['previous_application', 'licence', 'assigned_officer', 'applicant_profile', 'applicant'],
...
class AssignOfficerView(OfficerRequiredMixin, View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            application.assigned_officer = EmailUser.objects.get(
        ...
        if amendment_request_form.is_valid():
            ...
            response = {
                ...
                "amendment_request": serialize(
                    amendment_request, posthook=format_amendment_request
                ),
            }
